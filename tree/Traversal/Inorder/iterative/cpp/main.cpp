...
int main(int argc, char* argv[]) {
    ...
    const vector<int> order = InorderTraversal(leftChildren, rightChildren, root);
    ...
    if (timeInorder) {
        ...
        cout << "InorderTraversal call time (ms): " << (traversalDuration.count() / 1000.0) << '\n';
    } else {
