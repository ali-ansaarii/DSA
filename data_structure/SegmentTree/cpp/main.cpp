...
int main(int argc, char* argv[]) {
    ...
    const vector<long long> results = ProcessSegmentTreeQueries(initialValues, queries, errorMessage);
    ...
    if (timeSegmentTree) {
        ...
        cout << "Segment-tree time: " << elapsed.count() << " ms\n";
    } else {
        PrintAnswer(results);
    }
