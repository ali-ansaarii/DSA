...
## Benchmark Scope
The benchmark timer measures only the Fenwick-tree processing call in each
runner:

- building the Fenwick tree from the parsed initial array
- applying updates
...
So the reported time reflects the data-structure work itself, not full program
runtime.
